        ...
        <div className="grid lg:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative w-full h-140h-[640px] rounded-3xl overflow-hidden group shadow-2xl shadow-amber-900/10">
              <Image
                src="/images/tailor-made-sri-lanka.png"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 md:p-10">
                ...
                <div className="flex flex-wrap gap-2">
                  {["14 Days Average", "100% Private", "Fully Guided"].map(
                    (tag) => (
                      <span
                        key={tag}
          ...
          <div className="lg:pl-4">
            ...
            <p className="text-stone-600 text-lg leading-[1.8] mb-5">
              ...
              escapes and luxury safaris, every detail is curated to match your
              desires.
            </p>

            <p className="text-stone-600 text-lg leading-[1.8] mb-10">
              Romantic honeymoon, family adventure, or exclusive luxury escape —
              our specialists craft seamless itineraries with premium access and
              insider experiences you won't find anywhere else.
            </p>
            ...
            <ul className="space-y-3 mb-12">
              {[
                ...
                <li
                  key={item}
                  className="flex items-start gap-3 text-stone-700 text-base"
                >
